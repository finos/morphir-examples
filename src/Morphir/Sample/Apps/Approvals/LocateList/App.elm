...
The state exposes 2 functions in this case:
  ...
  - _requestApproval_ - Creates a command to initiate an approval request. The
  ...
  - _trackApprovalState_ - Creates a subscription to specific set of approval requests.
